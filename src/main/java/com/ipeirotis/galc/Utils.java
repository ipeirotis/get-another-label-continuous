...
public class Utils {
	...
	public void printLabels(Set<Category> categories, Set<Worker> workers, HashMap<CategoryWorker, Integer> m){
		System.out.print("Labels ");
		printMap(categories, workers, m);
	}
	public void printTrasposedLabels(Set<Category> categories, Set<Worker> workers, HashMap<CategoryWorker, Integer> m){
		System.out.print("Labels ");
		printTrasposedMap(categories, workers, m);
	}
	public void printMap(Set<Category> categories, Set<Worker> workers, HashMap<CategoryWorker, Integer> m){
	...
	public void printTrasposedMap(Set<Category> categories, Set<Worker> workers, HashMap<CategoryWorker, Integer> m){
